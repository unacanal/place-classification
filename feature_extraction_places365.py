...
train_set = torchvision.datasets.ImageFolder(root="dataset/MITPlaces_indoor/train", transform=transform)
test_set = torchvision.datasets.ImageFolder(root="dataset/MITPlaces_indoor/test", transform=transform)
