...
# torchvision.models.mnasnet0_75(pretrained=True)
### MNasNet
model_conv = torch.load("./checkpoints/MNASNet-20201006-211813/epoch-195.pkl") # torchvision.models.mnasnet1_0(pretrained=True)
for param in model_conv.layers.parameters():
     param.requires_grad = False
